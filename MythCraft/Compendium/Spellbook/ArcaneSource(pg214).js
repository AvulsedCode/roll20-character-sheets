...
Spells:[
{
   ...
   spellName:"Arcane Shield",
    ...
    APC: 1,"which you can spend reactively when targeted by a spell or magical effect."
    SPC: 3,
    Range: "Self",
    Requires: "Gesture",
    Duration: "1 round",
    ...
    SPC:  ½ the SP of the triggering spell,
    Range: "60 ft",
    ...
    prerequisites: ["Arcane Spell,Necromancy"],
    APC: 1,
    SPC: 40 minus the number of Death Points you are removing,
    Range: "60 ft",
    Requires: "Gesture, Visual",
    Duration: "Instantaneous",
    spellDescription: [
    ...
    spellName: "Shield",
    prerequisites: ["Arcane Spell, Warding"],
    APC: 1 Reactive AP that you can spend when you are the target of an attack,
    SPC: 3,
    Range: "Self",
    Requires: "Gesture",
    Duration: "1 round",
