const TalentStacks= [
...

    {
        ...
        isRepeatable: false,
        incompatableWith: [""],
        flavortext: "Gain 6 Skill Points, which you can spend on any skills with the Acrobatics tag.",
        BenefitList: [
            { benefitName: "", BenefitDescription: "" },
        ],
    ...
    {
        displayName: "",
        StackName: "Alchemy Expert",
        prerequisites: ["Skill Specialization"],
        isRepeatable: false,
        incompatableWith: [""],
        flavortext: "Gain +3 in the Alchemy skill. Each time you Take a Rest, you can craft a potion or a vial of caustic flame.Either option loses its potency after 24 hours.",
        BenefitList: [
    ...
    {
        displayName: "",
        StackName: "A Little Bit Of Soul",
        prerequisites: ["Skill Specialization"],
        isRepeatable: false,
        incompatableWith: [""],
        flavortext: "You gain 6 Skill Points you can assign to any skills with the INT tag.Additionally, when making a check with a skill that has the Crafting or Knowledge tag, and that is a skill you have Skill Points for, you may use your CHA instead of your INT for your Skill Check.",
        BenefitList: [
            { benefitName: "", BenefitDescription: "" },
        ],
    ...
    {
        displayName: "",
        StackName: "Animal Trainer",
        prerequisites: ["Skill Specialization, Animal Whisperer"],
        isRepeatable: false,
        incompatableWith: [""],
        flavortext: "If you use your Animal Whisperer ability on the same beast once per day for a month, the creature becomes a loyal pet. It trusts you and will risk its life to protect you.",
        BenefitList: [
            { benefitName: "", BenefitDescription: "" },
        ],
